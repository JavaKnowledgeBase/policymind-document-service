...
export default function BrandBar() {
  return (
    <header className="brand-bar" aria-label="PolicyMind Solutions brand">
      <div className="brand-logo" aria-hidden="true">
        <svg viewBox="0 0 520 140" role="img">
          <defs>
            <linearGradient id="pmBlue" x1="0%" y1="0%" x2="100%" y2="0%">
          ...
          <g transform="translate(6,16)">
            ...
            <path d="M66 104c8-24 26-38 52-36" stroke="url(#pmBlue)" strokeWidth="10" fill="none" strokeLinecap="round" />
